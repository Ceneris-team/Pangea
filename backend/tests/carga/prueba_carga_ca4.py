...
def crear_dispositivos(db, conexiones: list, ubicacion, mapeo) -> None:
...
def main() -> int:
    ...
    try:
        ...
        try:
            ...
            ubicacion, mapeo = crear_ubicacion_y_mapeo(db, id_sd)
            conexiones = crear_conexiones(db, id_sd)
            crear_dispositivos(db, conexiones, ubicacion, mapeo)
