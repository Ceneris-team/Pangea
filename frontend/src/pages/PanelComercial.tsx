          ...
          <main className="flex-1 overflow-y-auto p-6 md:p-8">
            <header className="mb-6">
              <h1 className="text-2xl font-bold text-gray-900 dark:text-white">
                Hola, {nombreCompleto ?? "Administrador Comercial"}
              </h1>
              <p className="text-sm text-gray-500 dark:text-gray-400">
                Panel de Administrador Comercial - Pangea 4.0.
              </p>
            </header>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-4">
              ...
              >
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">Gestiona las ubicaciones asociadas a tus clientes.</p>
              </Link>
              ...
              >
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">Revisa y actualiza tu información de acceso.</p>
              </Link>
            </div>
          </main>
        </div>
