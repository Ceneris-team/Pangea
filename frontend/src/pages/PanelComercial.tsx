          ...
          <main className="flex-1 overflow-y-auto p-6 md:p-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-4">
              ...
              >
                ...
                <h2 className="font-semibold text-white">Ubicaciones</h2>
                <p className="text-sm text-gray-300">Gestiona las ubicaciones asociadas a tus clientes.</p>
              </Link>
              ...
              >
                ...
                <p className="text-sm text-gray-300">Revisa y actualiza tu información de acceso.</p>
              </Link>
            </div>
          </main>
        </div>
