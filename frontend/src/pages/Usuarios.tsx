                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-300 mt-1">
                      <span className="font-medium text-gray-200">{creado.nmbr_cmplt}</span>{" "}
                    ...
                    <div className="flex gap-3 mt-4">
                      ...
                      <button
                        type="button"
                        onClick={abrirForm}
                        className="px-4 py-2 text-sm font-medium text-gray-200 bg-white bg-white/5 border border-white/20 rounded-lg hover:bg-white/5 transition-colors"
                      >
                        Agregar otro
                      </button>
                    </div>
            ...
            {mostrarForm && !creado && (
              <div className="bg-white/[0.04] backdrop-blur-md rounded-2xl shadow-sm border border-white/10 p-5 mb-6">
                ...
                <form onSubmit={guardarUsuario} className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm text-gray-200 mb-1">Nombre completo *</label>
                    <input
                      type="text"
                      value={form.nmbr_cmplt}
                      onChange={(e) => setForm((f) => ({ ...f, nmbr_cmplt: e.target.value }))}
                      className="bg-white/5 border border-white/20 text-white text-sm rounded-xl block w-full p-2.5 outline-none"
                    />
                  </div>
                  <div>
                  ...
                  <div>
                    <label className="block text-sm text-gray-200 mb-1">Rol *</label>
                    <select
                      value={form.rol_nombre}
                      onChange={(e) => setForm((f) => ({ ...f, rol_nombre: e.target.value }))}
                      className="bg-white/5 border border-white/20 text-white text-sm rounded-xl block w-full p-2.5 outline-none cursor-pointer"
                    >
                  ...
                  <div>
                    <label className="block text-sm text-gray-200 mb-1">Teléfono (opcional)</label>
                    <input
                      type="text"
                      value={form.tlfn}
                  ...
                  {errorForm && (
                    <div className="md:col-span-2 text-sm text-red-400">{errorForm}</div>
                  )}
                  ...
                  <div className="md:col-span-2 flex gap-3 justify-end">
                    <button
                      ...
                      disabled={guardando}
                      className="px-4 py-2 text-sm font-medium text-gray-200 bg-white bg-white/5 border border-white/20 rounded-lg hover:bg-white/5 disabled:opacity-50 transition-colors"
                    >
                      Cancelar
                    </button>
                    <button
                        ...
                        >
                          ...
                          <td className="px-6 py-4 text-right">
                            <button
                              ...
                              className="inline-flex items-center justify-center px-3 py-1.5 text-sm font-medium text-gray-200 bg-transparent border border-white/20 rounded-lg hover:bg-white/10 hover:text-white focus:ring-4 focus:outline-none focus:ring-white/10 disabled:opacity-50 disabled:hover:bg-transparent transition-all"
                            >
                              <svg className="w-4 h-4 mr-2 text-gray-300" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
                ...
                <div className="p-5 border-t border-white/10 flex items-center justify-between">
                  ...
                  <div className="inline-flex gap-2">
                    <button
                      ...
                      className="px-4 py-2 text-sm font-medium text-gray-200 bg-white bg-white/5 border border-white/20 rounded-lg hover:bg-white/5 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                    >
                      Anterior
                    </button>
                    <button
