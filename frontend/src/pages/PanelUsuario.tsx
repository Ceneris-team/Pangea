					...
					<main className="flex-1 overflow-y-auto p-6 md:p-8">
						...
						<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-4">
							...
							>
								...
								<h2 className="font-semibold text-gray-900 dark:text-white">Alarmas</h2>
								<p className="text-sm text-gray-600 dark:text-gray-300">Consulta y gestiona las alarmas configuradas sobre tus parámetros.</p>
							</Link>
