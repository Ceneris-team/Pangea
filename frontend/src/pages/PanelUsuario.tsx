					...
					<main className="flex-1 overflow-y-auto p-6 md:p-8">
						...
						<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-4">
							...
							>
								...
								<p className="text-sm text-gray-500 dark:text-gray-400">Consulta las sedes y estaciones asociadas a tu cuenta.</p>
							</Link>
							...
							>
								...
								<p className="text-sm text-gray-500 dark:text-gray-400">Revisa y actualiza tus datos personales.</p>
							</Link>
						</div>
					</main>
				</div>
