          ...
          <main className="flex-1 overflow-y-auto p-6 md:p-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              >
                ...
                <h2 className="font-semibold text-gray-900 dark:text-white">Conexión FTP</h2>
                <p className="text-sm text-gray-500 dark:text-gray-400">Gestionar y crear conexiones FTP.</p>
              </Link>
            </div>
          </main>
        </div>
